...
function calcularGasto(distancia, consumoKml, precoUnitario) {
...
const resultadoGasolina =
  calcularGasto(viagem.distancia, 10, precos.gasolina);

const resultadoDiesel =
  calcularGasto(200, 15, precos.diesel);

console.log("Viagem para: " + viagem.destino);

console.log(
  "Custo estimado no Diesel: R$ " +
  resultadoDiesel.toFixed(2)
);
